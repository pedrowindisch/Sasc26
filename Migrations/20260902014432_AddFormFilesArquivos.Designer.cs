...
namespace Sasc26.Migrations
{
    ...
    [Migration("20260902014432_AddFormFilesArquivos")]
    partial class AddFormFilesArquivos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sasc26.Models.FormFileAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int?>("PreRegistrationSubmissionId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PreRegistrationSubmissionId");
            ...
            modelBuilder.Entity("Sasc26.Models.FormFileAttachment", b =>
                {
                    ...
                    b.HasOne("Sasc26.Models.FormSubmission", "FormSubmission")
                        .WithMany()
                        .HasForeignKey("FormSubmissionId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Sasc26.Models.PreRegistrationFormSubmission", "PreRegistrationSubmission")
                        .WithMany()
                        .HasForeignKey("PreRegistrationSubmissionId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("PreRegistrationSubmission");
                });
